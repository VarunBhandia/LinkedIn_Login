...
============ Introduction ============
This small project helps web developers to implement the user registration with LinkedIn using PHP at their website. Also the user information would be stored at the MySQL database.
...
4. Open the inConfig.php file and specify the $appId, $appSecret, and $redirectURL as per your Facebook App credentials.
